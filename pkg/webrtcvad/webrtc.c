...
#include "webrtc/common_audio/signal_processing/spl_inl.c"
#include "webrtc/common_audio/signal_processing/spl_sqrt.c"
#include "webrtc/common_audio/signal_processing/vector_scaling_operations.c"
#include "webrtc/common_audio/third_party/spl_sqrt_floor/spl_sqrt_floor.c"
